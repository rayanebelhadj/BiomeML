#!/usr/bin/env python3
"""
Edge weight strategies for phylogenetic graphs.
9 different ways to compute weights from distance + abundance.
"""
...
def abundance_product(distance: float, abundance1: float, abundance2: float) -> float:
    """
    Professor's suggestion - abundance weighted.
    w = (1/d) * a1 * a2
    Emphasizes edges between abundant closely-related microbes.
    """
...
def compute_edge_weights_for_graph(edges: list, distances: dict, abundances: dict, 
    ...
    """
    Compute edge weights for all edges in a graph.
    Returns dict mapping (n1,n2) -> weight
    """
...
if __name__ == "__main__":
    ...
    print(f"inputs: d={d}, a1={a1}, a2={a2}")
    print("-" * 50)
